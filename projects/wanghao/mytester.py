...
maxnonerrCount = int(sys.argv[8])
maxerrCount = int(sys.argv[9])
maxnewCount = int(sys.argv[10])
...
def expandPool():
    ...
    if len(sut.newStatements()) != 0:
        ...
        nonerrCount += 1
        if nonerrCount > maxnonerrCount:
            errCount = maxnonerrCount
