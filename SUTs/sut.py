...
class sut(object):
    ...
    # END INITIALIZATION CODE
        ...
        self.__refCode['''self.p_avl[0].inorder() '''].append(r"len(self.p_avl_REF[0])")
        ...
        self.__refCode['''self.p_avl[1].inorder() '''].append(r"len(self.p_avl_REF[1])")
